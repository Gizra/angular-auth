...
angular.module('gz.angular-auth', ['angularLocalStorage'])
  .service('User', function($http, Base64, $q, storage, BACKEND_URL, $rootScope) {
     ...
     */
    this.login = function(url, userCredentials) {
      var deferred = $q.defer();

      $http({
        url: url,
        headers: {
          'Authorization': 'Basic ' + Base64.encode(userCredentials.username + ':' + userCredentials.password)
        },
    ...
    /**
     * Delete profile from local storage and object properties.
     */
